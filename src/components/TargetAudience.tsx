    ...
    <section className="relative py-24 px-0 w-full bg-gradient-to-br from-blue-50 via-blue-100 to-cyan-100 overflow-visible">
      ...
      <div className="relative z-10 w-full">
        <div className="text-center mb-16 px-4 sm:px-8 lg:px-16">
          <div className="inline-flex items-center gap-2 bg-blue-200/60 rounded-full px-8 py-3 mb-8 shadow-sm">
            <span className="text-blue-800 font-semibold tracking-wide text-lg">Perfect For</span>
          </div>
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-6 leading-tight tracking-tight text-gray-900">
            Built for Ambitious
            <span className="block bg-gradient-to-r from-blue-700 via-cyan-400 to-blue-500 bg-clip-text text-transparent drop-shadow-[0_2px_16px_rgba(37,99,235,0.18)]">Creators & Entrepreneurs</span>
          </h2>
          <p className="text-lg text-blue-900/90 max-w-2xl mx-auto font-medium leading-relaxed">
          ...
          {audienceClusters.map((cluster, idx) => {
            ...
            return (
              <div
                key={cluster.title}
                className={cn(
                  "flex-1 bg-white/90 backdrop-blur-md rounded-2xl shadow-lg border border-blue-200 min-w-[260px] max-w-[400px] mx-auto group flex flex-col items-center text-center p-10 transition-all duration-300",
                  "hover:shadow-2xl hover:shadow-blue-400/30 hover:-translate-y-2 hover:ring-2 hover:ring-blue-300/60 hover:ring-offset-2",
                )}
                style={{
              ...
              >
                <div
                  className={cn(
                    ...
                    cluster.iconBg,
                    "group-hover:from-blue-800 group-hover:to-cyan-400 group-hover:scale-110 group-hover:shadow-blue-300/40"
                  )}
                  style={{
                ...
                <p className="text-base text-blue-900/90 mb-6 leading-relaxed">
                  {cluster.description}
                </p>
                <ul className="flex flex-wrap justify-center gap-2">
                  {cluster.features.map((feature, idx) => (
                    <li key={idx}>
                      <span className="inline-block bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-800 font-semibold rounded-full px-4 py-1 text-xs shadow-sm border border-blue-200 transition-all duration-300 group-hover:scale-105 group-hover:bg-blue-50/80">
                        {feature}
                      </span>
                    </li>
                  ))}
